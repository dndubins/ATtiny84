...
```
Other than the prescaler, OCR1A is the only number we need to set here. It behaves according to the following chart, assuming an 8MHz clock speed:
...
```
/*  ATtiny84timedISR.ino - Timing an ISR using Timer 1 (without sleep)
Author: D. Dubins
Date: 24-Dec-24
...
--------------------------
ATTINY84 digital pin 0 -> Arduino Uno pin 0 RX (blue wire)
ATTINY84 digital pin 1 -> Arduino Uno pin 1 TX (white wire)
*/
